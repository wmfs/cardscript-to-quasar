...
module.exports = function applyLaunches (source, definition) {
  ...
  if (showSingleLaunchAsButton) {
    ...
    source
      ...
      .addAttribute('@click', `action('LaunchAction', { stateMachineName: ${launchesPath}[0].stateMachineName, input: ${launchesPath}[0].input, title: ${launchesPath}[0].title })`)
  ...
  const item = list
    ...
    .addAttribute('@click', 'action(\'LaunchAction\', { stateMachineName: launch.stateMachineName, input: launch.input, title: launch.title })')
