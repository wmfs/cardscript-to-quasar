...
const adaptiveCardTracker = require('./adaptive-card-tracker')
...
class TagNode {
  ...
  getDataPath () {
    ...
    */
    ...
    } else if (adaptiveCardTracker.insideAdaptiveCard()) {
      const { arrayPath, adaptiveCardId } = adaptiveCardTracker.getCurrentAdaptiveCard()
      dataPath = `${arrayPath}[${adaptiveCardId}Idx]`
    }
