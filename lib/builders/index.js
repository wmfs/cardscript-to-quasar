module.exports = {
  ...
  'Action.PushCard': { conversionFunction: require('./Action.PushCard') },
  'Action.ReplaceCard': { conversionFunction: require('./Action.ReplaceCard') },
  'Action.Cancel': { conversionFunction: require('./Action.Cancel') },
  'Action.NextTab': { conversionFunction: require('./Action.NextTab') },
  'Action.PreviousTab': { conversionFunction: require('./Action.PreviousTab') },
  'Action.Save': { conversionFunction: require('./Action.Save') },
  'Action.Stop': { conversionFunction: require('./Action.Stop') },
