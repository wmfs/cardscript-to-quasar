...
module.exports = function (definition, options) {
  ...
  if (id && bindToModel) {
    expansionItem.bindToModel(definition)
  }
  ...
  applySpacing({ spacing, source: expansionItem })
  ...
  if (tooltip) {
    const tooltipItemSection = templateHeader.addChildTag('q-item-section')
    applyTooltip({ source: tooltipItemSection, tooltip })
  }
