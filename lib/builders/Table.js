...
module.exports = function (definition, options) {
  ...
  if (selectionType) {
    ...
    bodyTr
      ...
      .addAttribute(':value', `!!${destPath}.find(r => hashSum(r) === hashSum(props.row))`)
      .addAttribute('@input', `action('ListSelection', { idx: props.rowIndex, sourcePath: '${safeInput(arrayPath)}', destPath: '${safeInput(destPath)}', selectionMax: ${0}, selectionType: '${selectionType}' })`)
  }
