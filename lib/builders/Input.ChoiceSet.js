...
module.exports = function (definition, options) {
  ...
  if (isMultiSelect || style === 'expanded') {
    ...
    if (id) {
      ...
      field.addAttribute(':error-message', `invalidFields && invalidFields['${id}'] ? invalidFields['${id}'].messages.join(' ') : ''`)
    }
    ...
    if (id) {
      ...
      select.addAttribute(':error-message', `invalidFields && invalidFields['${id}'] ? invalidFields['${id}'].messages.join(' ') : ''`)
    }
  }
