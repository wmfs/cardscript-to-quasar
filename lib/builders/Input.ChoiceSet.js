...
function select (div, definition) {
  ...
  selectItem
    ...
    .content('{{ props.opt.title || props.opt.label }}')
...
function radioOrCheckbox (div, definition, selectionType) {
  ...
  itemSectionLabel
    ...
    .addAttribute('v-if', 'Array.isArray(opt.subtitle || opt.sublabel)')
    .addChildTag('div')
    .addAttribute('v-for', '(sublabel, idx) in opt.subtitle || opt.sublabel')
    .addAttribute(':key', 'idx')
    .content('{{ sublabel }}')
  ...
  itemSectionLabel
    ...
    .addAttribute('caption', null)
    .addAttribute('class', 'q-my-sm')
    .addAttribute('v-if', 'typeof opt.subtitle === \'string\' || typeof opt.sublabel === \'string\'')
    .content('{{ opt.subtitle || opt.sublabel }}')
