...
module.exports = function (definition, options) {
  ...
  if (validation && validation.maxLength) {
    // const errString = `Please use maximum ${validation.maxLength} characters`
    rules += `val => val.length <= ${validation.maxLength} || 'Please use maximum ${validation.maxLength} characters'`
  }
  ...
  // TODO
  if (validation && id) input.addAttribute(':rules', rules + ']')
