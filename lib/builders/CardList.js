...
module.exports = function (definition, options) {
  ...
  if (instanceTitleTemplate) {
    ...
    itemSideActionBtn.addAttribute('unelevated', null)
    itemSideActionBtn.addAttribute('round', null)
    itemSideActionBtn.addAttribute('class', 'btn-primary')
  ...
  btn.addAttribute('class', 'btn-primary')
