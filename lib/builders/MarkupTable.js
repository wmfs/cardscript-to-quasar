...
function horizontal (qMarkupTable, definition) {
  ...
  for (const { value, showWhen, badge, tooltip, showLaunches } of columns) {
    ...
    if (showLaunches) {
      ...
      applyLaunches({
        source: l,
        showSingleLaunchAsButton: definition.showSingleLaunchAsButton,
        removableRows: definition.removableRows,
        removeInLaunches: definition.removeInLaunches,
        removeText: definition.removeText,
